...
public:
  enum class OutputTarget {
    ...
    TARGET_NOT_LOGGED = DEBUG_OUTCTL_NOT_LOGGED,
    TARGET_OVERRIDE_MASK = DEBUG_OUTCTL_OVERRIDE_MASK,
    TARGET_DML = DEBUG_OUTCTL_DML,
  };
...
public:
  ...
  void OutputVersionInformation(CDebugControl::OutputTarget target=CDebugControl::OutputTarget::TARGET_ALL_CLIENTS) const;
  ...
  void Output(const std::string& text, CDebugClient::OutputMask mask=CDebugClient::OutputMask::MASK_NORMAL, CDebugControl::OutputTarget target=CDebugControl::OutputTarget::TARGET_ALL_CLIENTS) const;
  ...
  void Execute(const std::string& command, ExecuteFlag flags=ExecuteFlag::EXECUTE_DEFAULT, CDebugControl::OutputTarget target=CDebugControl::OutputTarget::TARGET_ALL_CLIENTS) const;
  void ExecuteCommandFile(const std::string& commandFile, ExecuteFlag flags=ExecuteFlag::EXECUTE_DEFAULT, CDebugControl::OutputTarget target=CDebugControl::OutputTarget::TARGET_ALL_CLIENTS) const;
  ...
  ULONG64 OutputDisassembly(ULONG64 offset, DisassembleFlag flags=DisassembleFlag::DISASM_DEFAULT, CDebugControl::OutputTarget target=CDebugControl::OutputTarget::TARGET_ALL_CLIENTS) const;
  ...
  void OutputTextReplacements(CDebugControl::OutputTarget target=CDebugControl::OutputTarget::TARGET_ALL_CLIENTS) const;
