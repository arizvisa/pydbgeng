...
/** accessors */
  enum class KernelAttachFlags : ULONG {
  ...
  enum class RunningProcessSystemIdFlags {
  ...
  enum class RunningProcessDescriptionFlags {
  ...
  enum class ConnectSessionFlags {
...
/** Debugging Event callbacks */
  ...
  public:
      ...
      enum class ChangeDebuggeeStateFlags {
      ...
      enum class ChangeDebuggeeStateRefreshIds {
      ...
      enum class ChangeEngineStateFlags {
      ...
      enum class ChangeSymbolStateFlags {
  ...
  private:
      ...
      HRESULT CallEventCallback(ULONG id, const T& args)
      {
          ...
          if (result.is_none())
            return CDebugControl::STATUS_NO_CHANGE;
...
/** Output callbacks */
  ...
  public:
      ...
      CDebugClient::OutputMask GetMask(void) const;
...
/** Methods */
  ...
  void OutputIdentity(const std::string& format="%s", CDebugControl::OutputTarget target=CDebugControl::OutputTarget::TARGET_ALL_CLIENTS) const;

  // Kernel debugging
  void AttachKernel(KernelAttachFlags flags=KernelAttachFlags::ATTACH_LOCAL_KERNEL, const std::string& connectOptions="") const;
