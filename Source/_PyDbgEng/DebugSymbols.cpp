...
void CDebugSymbols::Export(void)
{
  enum_<CDebugSymbols::SymbolOption>("SymbolOption")
    .value("CASE_INSENSITIVE",          CDebugSymbols::SymbolOption::OPT_CASE_INSENSITIVE)
    .value("UNDNAME",                   CDebugSymbols::SymbolOption::OPT_UNDNAME)
    .value("DEFERRED_LOADS",            CDebugSymbols::SymbolOption::OPT_DEFERRED_LOADS)
    .value("NO_CPP",                    CDebugSymbols::SymbolOption::OPT_NO_CPP)
    .value("LOAD_LINES",                CDebugSymbols::SymbolOption::OPT_LOAD_LINES)
    .value("OMAP_FIND_NEAREST",         CDebugSymbols::SymbolOption::OPT_OMAP_FIND_NEAREST)
    .value("LOAD_ANYTHING",             CDebugSymbols::SymbolOption::OPT_LOAD_ANYTHING)
    .value("IGNORE_CVREC",              CDebugSymbols::SymbolOption::OPT_IGNORE_CVREC)
    .value("NO_UNQUALIFIED_LOADS",      CDebugSymbols::SymbolOption::OPT_NO_UNQUALIFIED_LOADS)
    .value("FAIL_CRITICAL_ERRORS",      CDebugSymbols::SymbolOption::OPT_FAIL_CRITICAL_ERRORS)
    .value("EXACT_SYMBOLS",             CDebugSymbols::SymbolOption::OPT_EXACT_SYMBOLS)
    .value("ALLOW_ABSOLUTE_SYMBOLS",    CDebugSymbols::SymbolOption::OPT_ALLOW_ABSOLUTE_SYMBOLS)
    .value("IGNORE_NT_SYMPATH",         CDebugSymbols::SymbolOption::OPT_IGNORE_NT_SYMPATH)
    .value("INCLUDE_32BIT_MODULES",     CDebugSymbols::SymbolOption::OPT_INCLUDE_32BIT_MODULES)
    .value("PUBLICS_ONLY",              CDebugSymbols::SymbolOption::OPT_PUBLICS_ONLY)
    .value("NO_PUBLICS",                CDebugSymbols::SymbolOption::OPT_NO_PUBLICS)
    .value("AUTO_PUBLICS",              CDebugSymbols::SymbolOption::OPT_AUTO_PUBLICS)
    .value("NO_IMAGE_SEARCH",           CDebugSymbols::SymbolOption::OPT_NO_IMAGE_SEARCH)
    .value("SECURE",                    CDebugSymbols::SymbolOption::OPT_SECURE)
    .value("NO_PROMPTS",                CDebugSymbols::SymbolOption::OPT_NO_PROMPTS)
    .value("OVERWRITE",                 CDebugSymbols::SymbolOption::OPT_OVERWRITE)
    .value("IGNORE_IMAGEDIR",           CDebugSymbols::SymbolOption::OPT_IGNORE_IMAGEDIR)
    .value("FLAT_DIRECTORY",            CDebugSymbols::SymbolOption::OPT_FLAT_DIRECTORY)
    .value("FAVOR_COMPRESSED",          CDebugSymbols::SymbolOption::OPT_FAVOR_COMPRESSED)
    .value("ALLOW_ZERO_ADDRESS",        CDebugSymbols::SymbolOption::OPT_ALLOW_ZERO_ADDRESS)
    .value("DISABLE_SYMSRV_AUTODETECT", CDebugSymbols::SymbolOption::OPT_DISABLE_SYMSRV_AUTODETECT)
    .value("DEBUG",                     CDebugSymbols::SymbolOption::OPT_DEBUG)
    ;

  enum_<CDebugSymbols::TypeOption>("TypeOption")
    .value("DEFAULT",             CDebugSymbols::TypeOption::OPT_TYPE_DEFAULT)
    .value("UNICODE_DISPLAY",     CDebugSymbols::TypeOption::OPT_UNICODE_DISPLAY)
    .value("LONGSTATUS_DISPLAY",  CDebugSymbols::TypeOption::OPT_LONGSTATUS_DISPLAY)
    .value("FORCERADIX_OUTPUT",   CDebugSymbols::TypeOption::OPT_FORCERADIX_OUTPUT)
    .value("MATCH_MAXSIZE",       CDebugSymbols::TypeOption::OPT_MATCH_MAXSIZE)
    ;
  ...
  class_<CDebugSymbols::CType>("Type", no_init)
    ...
    .def("OutputPhysical", &CDebugSymbols::CType::OutputPhysical,
      ("offset", arg("options")=TypeOption::OPT_TYPE_DEFAULT, arg("target")=CDebugControl::OutputTarget::TARGET_ALL_CLIENTS),
...
const list CDebugSymbols::GetSymbolOptions(void) const
{
  ...
  return utils::FlagsToList(static_cast<SymbolOption>(options), SymbolOption::OPT_CASE_INSENSITIVE, SymbolOption::OPT_DEBUG);
}
...
const list CDebugSymbols::GetTypeOptions(void) const
{
  ...
  return utils::FlagsToList(static_cast<TypeOption>(options), TypeOption::OPT_UNICODE_DISPLAY, TypeOption::OPT_MATCH_MAXSIZE);
}
...
void
CDebugSymbols::CType::OutputPhysical(ULONG64 offset, CDebugSymbols::TypeOption options, CDebugControl::OutputTarget target)
{
  Check(m_intf->OutputTypedDataPhysical((ULONG) target, offset, m_module, m_id, (ULONG) options));
}

void
CDebugSymbols::CType::OutputVirtual(ULONG64 offset, CDebugSymbols::TypeOption options, CDebugControl::OutputTarget target)
{
